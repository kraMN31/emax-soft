pipeline {
    ...
    environment {
        registry = '740955001227.dkr.ecr.us-east-1.amazonaws.com/geolocation_ecr_rep'
        ...
        stage('Pushing to ECR') {
            steps{
                script {
                    ...
                    sh 'docker push 740955001227.dkr.ecr.us-east-1.amazonaws.com/geolocation_ecr_rep:latest'
                }
            }
        }
    }
